...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="flex dark:bg-transparent  justify-between w-full py-8 lg:px-10 px-8 items-center text-black">
        <div className="flex items-center justify-between z-20 w-full">
          <h1 className="sm:text-5xl text-4xl text-black dark:text-white logo cursor-pointer">
          ...
          <ul className="lg:flex hidden gap-x-5 z-20 ">
            <Switch
              ...
              className={`relative flex h-8 w-16 cursor-pointer rounded-full p-1 transition-colors duration-300 ease-in-out ${
                isDarkMode ? "bg-white/20" : "bg-[#FFD700]/70"
              } `}
            >
              <span
                aria-hidden="true"
            ...
            <li>
              <a
                ...
                download
                className="bg-yellow-500 dark:text-[#001524] text-white py-2 px-4 rounded-lg transition duration-300 ease-in-out transform hover:bg-yellow-400 hover:scale-105"
              >
                Download CV
              </a>
            </li>
        ...
        >
          ...
          <div className="flex flex-col items-center justify-center h-full text-white space-y-6">
            <ul className="text-2xl flex flex-col gap-y-5">
              ...
              <li className="flex items-center gap-x-3 hover:-translate-y-1 ease-in-out transition hover:scale-110">
                <a
                  href="mailto:danendrapr55@gmail.com"
                  className="flex items-center gap-x-3"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"

...
export default function Navbar({
  ...
  return (
    <navbar className="flex  justify-between w-full py-8 px-10 items-center text-white">
      <div className="flex items-center justify-between z-20 w-full">
        <h1 className="sm:text-5xl text-3xl text-white logo">
          ROFL<span className="text-red-700">1</span>ST
        </h1>
